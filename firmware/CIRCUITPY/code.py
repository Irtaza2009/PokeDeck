...
backlight = pwmio.PWMOut(board.GP17, frequency=5000, duty_cycle=65535)  # Full brightness
backlight.duty_cycle = 30000  # Dimmed (adjust this value as needed)
...
display = ST7735R(display_bus, width=128, height=128, colstart=0, rowstart=16, bgr=True)
...
# Load the bitmap and palette using imageload
hackamon_sheet_idle, hackamon_palette = adafruit_imageload.load(
    "assets/Hackamon-1-Idle-Spritesheet.bmp",
    bitmap=displayio.Bitmap,
    palette=displayio.Palette
)

hackamon_palette.make_transparent(0)

# Create a TileGrid using the loaded bitmap and palette
hackamon_sprite_idle = displayio.TileGrid(
    hackamon_sheet_idle,
    pixel_shader=hackamon_palette,
    width=1,
    height=1,
...
# Hackamon Jump Sheet
hackamon_sheet_jump, hackamon_palette_jump = adafruit_imageload.load(
    "assets/Hackamon-1-Jump-Spritesheet.bmp",
    bitmap=displayio.Bitmap,
    palette=displayio.Palette
)
hackamon_palette_jump.make_transparent(0)

hackamon_sprite_jump = displayio.TileGrid(
    hackamon_sheet_jump,
    pixel_shader=hackamon_palette_jump,
    width=1,
    height=1,
    tile_width=tile_width,
    tile_height=tile_height,
...
# Hackamon Charging Sheet
hackamon_sheet_charging, hackamon_palette_charging = adafruit_imageload.load(
    "assets/Hackamon-1-Charging-Spritesheet.bmp",
    bitmap=displayio.Bitmap,
    palette=displayio.Palette
)
hackamon_palette_charging.make_transparent(0)

hackamon_sprite_charging = displayio.TileGrid(
    hackamon_sheet_charging,
    pixel_shader=hackamon_palette_charging,
    width=1,
    height=1,
    tile_width=tile_width,
    tile_height=tile_height,
...
# Load button 1 sprite sheet
button_1_sheet, button_1_palette = adafruit_imageload.load(
    "assets/Button-1-Spritesheet.bmp",
    bitmap=displayio.Bitmap,
    palette=displayio.Palette
)
button_1_palette.make_transparent(0)

button_1_sprite = displayio.TileGrid(
    button_1_sheet,
    pixel_shader=button_1_palette,
    width=1,
    height=1,
    tile_width=16,
    tile_height=18,
...
# Load button 2 sprite sheet
button_2_sheet, button_2_palette = adafruit_imageload.load(
    "assets/Button-2-Spritesheet.bmp",
    bitmap=displayio.Bitmap,
    palette=displayio.Palette
)
button_2_palette.make_transparent(0)

button_2_sprite = displayio.TileGrid(
    button_2_sheet,
    pixel_shader=button_2_palette,
    width=1,
    height=1,
    tile_width=16,
    tile_height=18,
...
# Load button 3 sprite sheet
button_3_sheet, button_3_palette = adafruit_imageload.load(
    "assets/Button-3-Spritesheet.bmp",
    bitmap=displayio.Bitmap,
    palette=displayio.Palette
)
button_3_palette.make_transparent(0)

button_3_sprite = displayio.TileGrid(
    button_3_sheet,
    pixel_shader=button_3_palette,
    width=1,
    height=1,
    tile_width=16,
    tile_height=18,
...
# Load Happiness Bar spritesheet
happiness_bar_sheet, happiness_bar_palette = adafruit_imageload.load(
    "assets/Happiness-Bar-Spritesheet.bmp",
    bitmap=displayio.Bitmap,
    palette=displayio.Palette
)
happiness_bar_palette.make_transparent(0)

happiness_bar_sprite = displayio.TileGrid(
    happiness_bar_sheet,
    pixel_shader=happiness_bar_palette,
    width=1,
    height=1,
    tile_width=48,
    tile_height=10,
...
# Load Battery Bar spritesheet
battery_bar_sheet, battery_bar_palette = adafruit_imageload.load(
    "assets/Battery-Bar-Spritesheet.bmp",
    bitmap=displayio.Bitmap,
    palette=displayio.Palette
)
battery_bar_palette.make_transparent(0)

battery_bar_sprite = displayio.TileGrid(
    battery_bar_sheet,
    pixel_shader=battery_bar_palette,
    width=1,
    height=1,
    tile_width=48,
    tile_height=10,
...
# Load Day-Night Cycle Bar spritesheet
day_night_cycle_bar_sheet, day_night_cycle_bar_palette = adafruit_imageload.load(
    "assets/Day-Night-Bar-Spritesheet.bmp",
    bitmap=displayio.Bitmap,
    palette=displayio.Palette
)
day_night_cycle_bar_palette.make_transparent(0)

day_night_cycle_bar_sprite = displayio.TileGrid(
    day_night_cycle_bar_sheet,
    pixel_shader=day_night_cycle_bar_palette,
    width=1,
    height=1,
    tile_width=48,
    tile_height=10,
...
# Load charging station bitmap with imageload
charging_station_sheet, charging_station_palette = adafruit_imageload.load(
    "assets/Charging-Station.bmp",
    bitmap=displayio.Bitmap,
    palette=displayio.Palette
)
charging_station_palette.make_transparent(0)

# Create the TileGrid
charging_station_sprite = displayio.TileGrid(
    charging_station_sheet,
    pixel_shader=charging_station_palette,
    width=1,
    height=1,
    tile_width=55,
    tile_height=42,
...
# Load as Bitmap instead of OnDiskBitmap
pointer_bitmap, pointer_sheet = adafruit_imageload.load("assets/Pointer-Spritesheet-2x.bmp",
                                          bitmap=displayio.Bitmap,
                                          palette=displayio.Palette)

pointer_sheet.make_transparent(0)  # Force transparency on index 0

pointer_sprite_1 = displayio.TileGrid(pointer_bitmap,
                                        pixel_shader=pointer_sheet,
                                        width=1,
                                        height=1,
                                        tile_width=14,
                                        tile_height=12,
...
pointer_sprite_2 = displayio.TileGrid(pointer_bitmap,
                                        width=1,
                                        pixel_shader=pointer_sheet,
                                        height=1,
                                        tile_width=14,
...
pointer_sprite_3 = displayio.TileGrid(pointer_bitmap,
                                        width=1,
                                        pixel_shader=pointer_sheet,
                                        height=1,
                                        tile_width=14,
...
# Load brick sheet using imageload
brick_sheet, brick_palette = adafruit_imageload.load(
    "assets/Breakout-Bricks-Spritesheet.bmp",
    bitmap=displayio.Bitmap,
    palette=displayio.Palette
)
brick_palette.make_transparent(0)

# Load ball sheet using imageload
ball_sheet, ball_palette = adafruit_imageload.load(
    "assets/Breakout-Ball.bmp",
    bitmap=displayio.Bitmap,
    palette=displayio.Palette
)
ball_palette.make_transparent(0)
...
def write_stats(stats):
    try:
        storage.remount("/", readonly=False)  # Force read-write mount
        with open(stats_file, "w") as file:
            for key in stats:
                file.write("%s=%d\n" % (key, stats[key]))
    except OSError as e:
        print("Couldn't write stats:", e)
...
while True:
    ...
    framePointer = (framePointer + 1) % (pointer_bitmap.width // 14)
